...
const CreatePin = ({ user }) => {
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
            {fields && (
                <p className='text-red-500 mb-5 text-xl transition-all duration-150 ease-in'>Please fill in the all fields</p>
            )}
            <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                ...
                <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
                    ...
                    <input
                        ...
                        placeholder="What is Destination"
                        className='outline-none text-base sm:text-lg font-bold border-b-2 border-gray-200 p-2'
                    />
                    <div className='flex flex-col'>
                        <div>
                            ...
                            <select
                                ...
                                className='outline-none w-3/5 text-base border-b-2 border-gray-200 rounded-md cursor-pointer'
                            >
                                <option value='other' className='bg-white'>Select Category</option>
                                {
                                    categories.map((category) => (
                                        <option value={category.name} className='text-base bg-white text-black outline-none capitalize border-0'>
                                            {category.name}
                                        </option>
                                    ))
                                }
